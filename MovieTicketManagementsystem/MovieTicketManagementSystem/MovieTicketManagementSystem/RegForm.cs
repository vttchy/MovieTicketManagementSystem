...
namespace MovieTicketManagementSystem
{
    public partial class RegForm : Form
    {
        ...
        {
            // Thực hiện hành động khi label1 được click, hoặc để trống nếu không cần thiết
        }

        private void label7_Click(object sender, EventArgs e)
        {
            // Thực hiện hành động khi label7 được click, hoặc để trống nếu không cần thiết
        }
        ...
        private void reg_NumberPhone_TextChanged_1(object sender, EventArgs e)
        {
